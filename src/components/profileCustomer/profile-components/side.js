          ...
          <div className='side-block-two'>
              ...
              <div className='side-verif'>
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.customerProfile.phoneStatus === 0 ?
                  ...
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.customerProfile.mailStatus === 0 ?
                         <img src={close} width={24} alt='.'/>
                      :
                          <img src={check} width={24} alt='.'/>
                      }
                  ...
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.customerProfile.validateAccount === 0 ?
                          <img src={close} width={24} alt='.'/>
                      :
                          <img src={check} width={24} alt='.'/>
                      }
