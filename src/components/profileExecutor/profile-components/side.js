    ...
    <>
      <div className="side">
          ...
          <div className='side-block-two'>
              ...
              <div className='side-verif'>
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.executorProfile.phoneStatus === 0 ?
                  ...
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.executorProfile.mailStatus === 0 ?
                         <img src={close} width={24} alt='.'/>
                      :
                          <img src={check} width={24} alt='.'/>
                      }
                  ...
                  <div className='side-verif-text'>
                      ...
                      {userProfile.userProfile.response.executorProfile.validateAccount === 0 ?
                          <img src={close} width={24} alt='.'/>
                      :
                          <img src={check} width={24} alt='.'/>
                      }
        ...
        <div className='text-main-about-mobile'>
            <span>{userProfile.userProfile.response.executorProfile.about}</span>
        </div>
      </>
    );
  }
