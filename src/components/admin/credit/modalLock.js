...
import { acceptCreditRequest, setUserLock } from '../../../http/adminApi';
    ...
    return (
        <div className={activeTwo ? "login active" : "login"} onClick={() => setActiveTwo(false)}>
            ...
            <div className="login-text">
                ...
                <p>Вы уверены в одобрение кредита?</p>
                <div className='modal-block-button mt-15'>
                    <button className='modal-button-adm mr' onClick={() => {
                        acceptCreditRequest(infoUserOne).then(() => window.location.reload())
                    }}>Одобрить</button>
