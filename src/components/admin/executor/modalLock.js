...
import { setCustomerValidateAccount, setExecutorValidateAccount, setUserLock } from '../../../http/adminApi';
    ...
    return (
        <div className={activeTwo ? "login active" : "login"} onClick={() => setActiveTwo(false)}>
            ...
            <div className="login-text">
                ...
                <p>Вы уверены в верификации пользователя?</p>
                <div className='modal-block-button mt-15'>
                    <button className='modal-button-adm mr' onClick={() => {
                        setExecutorValidateAccount(infoUserOne).then(() => window.location.reload())
