...
const ListUserExecutor = () => {
    const [list, setList] = useState()
    const [search, setSearch] = useState('')
    useEffect(() => {
        getExecutors().then((data) => setList(data))
    },[])
    ...
    const handleButtonPostList = () => {
        getExecutors(search).then((data) => setList(data))
    }
      ...
      <div className="">
        ...
        <div className="none-mt container">
            <div className="work-search-block">
                <h1 className="work-search-text">Список Исполнителей</h1>
            ...
            <div className="block-adm-list">
                <ul>
                        <div className="block-list-user-all">
                            {list && list.executors && list.executors.slice(0, displayCount).map((res,index) => {
                                return (
                                    <>
                                    <div className="block-list-adm">
                                     ...
                                     <div className="block-list-user">
                                         ...
                                         <div className="block-list-card">
                                             <div className="block-list-user-about">
                                                 <li className="block-list-user-about-l">Рейтинг Исполнителя</li> 
                                             </div>
                                            <li>{res.rate}</li>
                                         </div>
                                         <div className="block-list-card">
...
export default ListUserExecutor;