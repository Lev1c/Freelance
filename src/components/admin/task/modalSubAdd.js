...
import { addSubTaskCategories, changeTaskCategories, setUserModeratorComment } from '../../../http/adminApi';
...
const ModalSubAdd = observer(({activeSix, setActiveSix, infoUserOne}) => {
    ...
    return (
        <div className={activeSix ? "login active" : "login"} onMouseDown={() => setActiveSix(false)}>
