...
import { setCustomerValidateAccount, setUserUnLock } from '../../../http/adminApi';
        ...
        <div className={activeThree ? "login active" : "login"} onClick={() => setActiveThree(false)}>
            ...
            <div className="login-text">
                ...
                <div className='modal-block-button mt-15'>
                    <button className='modal-button-adm mr' onClick={() => setCustomerValidateAccount(infoUserOne).then(() => window.location.reload())}>Разблокировать</button>
