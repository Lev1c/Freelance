...
import { setCustomerModeratorComment, setUserModeratorComment } from '../../../http/adminApi';
            ...
            <div className="login-text">
                ...
                <div className='modal-block-button mt-15'>
                    <button className='modal-button-adm mr' onClick={() => {
                        setCustomerModeratorComment(login, infoUserOne).then(() => window.location.reload())
                    }}>Отправить</button>
